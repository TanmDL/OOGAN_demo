...
def cos_similarity(weight):
    weight = weight / weight.norm(dim=-1).unsqueeze(-1)      ###### last dimension norm then add to add a dimesion in last
...
##### still now I couldnot understand it 
...
oogan = OOGANInput(10, 30, 512, 256)
print(oogan) 



####################### infoGAN normal generator nothing is there   
